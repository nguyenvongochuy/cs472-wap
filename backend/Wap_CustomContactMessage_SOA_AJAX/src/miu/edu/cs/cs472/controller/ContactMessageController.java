...
public class ContactMessageController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
        ...
        String contactMessageJSONData = contactMessageService.getContactMessagesJSON();
        System.out.println(contactMessageJSONData);
        response.setContentType("application/json");
        response.setBufferSize(4096);
        response.getWriter().println(contactMessageJSONData);
